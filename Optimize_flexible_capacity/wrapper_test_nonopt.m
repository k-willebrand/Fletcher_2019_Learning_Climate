...
% This nonopt version the wrapper test function is intended for use on the cluster to submit multiple
% jobs
...
savename = strcat('ga_flex_design_nonopt');
save(savename, 'x', 'fval', 'exitFlag', 'Output')
saveas(gcf,'GA_Graphs_nonopt.fig')
saveas(gcf,'GA_Graphs_nonopt.png')